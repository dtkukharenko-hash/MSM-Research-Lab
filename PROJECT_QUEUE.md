...
Кандидат по итогам EXP-003: **EXP-004 — DIRECTION/REGIME EXISTENCE** — каузальная оценка режима vs
null-моделей (N1 shuffle, N2 block-boot), критерии существования/опровержения фиксируются до расчёта.
Требует решения архитектора по открытым вопросам из `EXP-003_MINIMAL_OBJECT_REVIEW/REPORT.md`.
